...
chainStep = int(totalTrackLen/singleTrackLen)
chainStep += 1
...
for i in range(chainStep):
    ...
    if(i != (chainStep - 1)):
        ...
        cmds.pathAnimation (dup, fm=1, f=1, fa='z' ,ua='y', wut="object", wuo="L_TrackUP", iu=1, inverseFront=1, b=0, stu=(1+i), etu=(chainStep+i), c=totalTrack)
